    ...
    */
    template: {
      ...
      tip:{
        ...
        "抢和假":'<div class="tag_primary"><span class="tag_content">{$qtype}</span></div><div class="tag_rest"><span class="tag_content">{$jtype}</span></div>'
      }
    },
    /**
    * 样式名
